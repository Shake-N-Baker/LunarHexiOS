...
/**
 The Main Scene class acts as the main controller, handles updates from the scene and distributes them to sub
 controllers.
 */
class MainScene: SKScene {
    ...
    /**
     ...
     - Parameter touches: A set of [UITouch](apple-reference-documentation://hsatbdjPCV)
     instances that represent the touches for the starting phase of the event, which is represented by event. For
     touches in a view, this set contains only one touch by default. To receive multiple touches, you must set the
     view's [isMultipleTouchEnabled](apple-reference-documentation://hsyDhIpFIc) property to true.
    ...
    /**
     ...
     - Parameter touches: A set of [UITouch](apple-reference-documentation://hsatbdjPCV)
     instances that represent the touches whose values changed. These touches all belong to the specified event.
     For touches in a view, this set contains only one touch by default. To receive multiple touches, you must set the
     view's [isMultipleTouchEnabled](apple-reference-documentation://hsyDhIpFIc) property to true.
     - Parameter event: The event to which the touches belong.
     */
    ...
    /**
     ...
     - Parameter touches: A set of [UITouch](apple-reference-documentation://hsatbdjPCV)
     instances that represent the touches for the ending phase of the event represented by event. For touches in a
     view, this set contains only one touch by default. To receive multiple touches, you must set the view's
     [isMultipleTouchEnabled](apple-reference-documentation://hsyDhIpFIc) property to true.
     - Parameter event: The event to which the touches belong.
     */
